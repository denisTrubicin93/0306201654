...
function showComments() {
    ...
    comments.forEach(function (item) {
        out += '<li class="user_comment"><div class="info"><span class="user-name">' + item.name + '</span><span class="time">' + timeConverter(item.time) + '</span ></div> <p id="comment_text">' + item.body + '</p></li>';
    });
